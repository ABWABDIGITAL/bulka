...
import 'package:bulka/modules/authentication/company_register/ui/views/company_register_screen.dart';
import 'package:bulka/modules/authentication/user_register/ui/views/user_register_screen.dart';
        ...
        onPressed: () {
          switch (cubit.userRole) {
            case UserRole.company:
              ...
              return;
            case UserRole.user:
              context.push(const UserRegisterScreen());
              return;
            default:
              return;
          }
