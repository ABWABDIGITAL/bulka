...
class ResendVerificationCodeWidget extends StatefulWidget {
  const ResendVerificationCodeWidget({super.key});

  @override
  State<ResendVerificationCodeWidget> createState() =>
      _ResendVerificationCodeWidgetState();
}

class _ResendVerificationCodeWidgetState
    extends State<ResendVerificationCodeWidget> {
  Timer? _timer;
